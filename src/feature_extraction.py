...
conv_base = VGG16(weights='imagenet', include_top=False, input_shape=(150, 150, 3)) # TODO: Student - Load the VGG16 model (see writeup)
datagen = ImageDataGenerator(rescale=1.0/255.0)   # TODO: Student - create a data generator  (see part 3)
